3@extends('layouts.app', ['activePage' => 'dashboard', 'titlePage' => __('Dashboard')])
  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
            <div class="col-md-4">
            <form method="post" action="{{route('front.create')}}" class="form-horizontal" enctype="multipart/form-data">
            <img src="/images/{{$front->logo}}" width="100" alt="">
                        {!! Form::file('logo') !!}
