...
{!! Form::open(['action' => ['lectureController@update', $lecture->id], 'method' => 'POST', 'class'=>'row']) !!}
    ...
    <input type="text" class="form-control was-valid" placeholder="Lecture name" name="lecture" value="{{$lecture->lecture}}" required>
    </div>
    ...
    <div class="col-md-12">
      ...
      <input type="text" class="form-control was-valid" placeholder="Lecture file URL" name="url" value="{{$lecture->url}}" required>
    </div>
